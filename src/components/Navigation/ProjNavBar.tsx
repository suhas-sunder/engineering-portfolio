      ...
      <div className="mx-auto flex max-w-[1600px] justify-between">
        {prevProjName ? (
          <Link
            ...
            className="flex min-w-0 w-full cursor-pointer items-center justify-center gap-3 px-5 py-4 text-center text-sm font-semibold text-slate-100 transition hover:bg-sky-400/10 hover:text-sky-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-sky-400 sm:gap-5 sm:px-8 sm:text-[1.15rem]"
          >
            <span>
              <FontAwesomeIcon
                icon={arrowLeft}
            ...
            <span className="min-w-0 break-words">{prevProjName}</span>
          </Link>
        ) : (
        ...
        {nextProjName ? (
          <Link
            ...
            className="flex min-w-0 w-full cursor-pointer items-center justify-center gap-3 px-5 py-4 text-center text-sm font-semibold text-slate-100 transition hover:bg-sky-400/10 hover:text-sky-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-sky-400 sm:gap-5 sm:px-8 sm:text-[1.15rem]"
          >
            <span className="min-w-0 break-words">{nextProjName}</span>
            <span>
              <FontAwesomeIcon
                icon={arrowRight}
                className={Styles["arrow-icon"]}
