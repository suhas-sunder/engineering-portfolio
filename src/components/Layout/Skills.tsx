    ...
    >
      <div className="relative flex w-full flex-col">
        ...
        <ExpandingListContainer
          customBtnStyle="border-t border-slate-700 bg-slate-800 py-4 text-sm font-semibold text-sky-300 transition hover:bg-slate-700 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-sky-400"
            ...
            {skillsData.map((data) => (
              ...
              >
                ...
                <span
                  ...
                  className="flex min-h-9 w-full max-w-[13rem] items-center justify-center rounded-md border border-slate-700 bg-slate-950 px-3 py-2 text-center text-xs font-semibold text-slate-100 sm:box-content sm:text-sm md:text-base"
                  title={data.skill}
                >
                  {data.skill}
                </span>
