        ...
        {visibleTags.length > 0 ? (
          <ul className="mt-3 flex min-w-0 flex-wrap gap-2">
            {visibleTags.map((tag) => (
              <li
                key={`${title}-${tag}`}
                className="max-w-full rounded-full border border-sky-400/20 bg-sky-400/10 px-2.5 py-1 text-center text-[0.72rem] leading-snug font-semibold text-sky-200"
                title={tag}
              >
                {tag}
              </li>
          ...
          <div className="mt-auto flex min-w-0 flex-wrap gap-2.5 pt-4">
            {hasLiveDemo ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex min-h-11 max-w-full cursor-pointer items-center justify-center rounded-lg border border-sky-500 bg-sky-500 px-4 py-2 text-sm font-semibold text-white transition hover:border-sky-400 hover:bg-sky-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400"
            ...
            {hasGithub ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex min-h-11 max-w-full cursor-pointer items-center justify-center rounded-lg border border-slate-600 bg-slate-800 px-4 py-2 text-sm font-semibold text-slate-100 transition hover:border-sky-400 hover:bg-slate-950 hover:text-sky-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400"
